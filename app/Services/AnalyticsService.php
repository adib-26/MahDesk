...
class AnalyticsService
{
    ...
    public function forWorkspace(Workspace $workspace): array
    {
        ...
        return [
            ...
            'agents' => $this->agentLeaderboard($workspace, $open, $resolvedInWindow),
        ];
    }
    ...
    private function agentLeaderboard(Workspace $workspace, $open, $resolvedInWindow): array
    {
        return $workspace->members->map(function ($member) use ($open, $resolvedInWindow) {
