...
Route::middleware('auth')->group(function () {
    ...
    Route::post('settings/two-factor', [TwoFactorAuthenticationController::class, 'start'])->name('two-factor.start');
    ...
    Route::post('settings/two-factor/recovery-codes', [TwoFactorAuthenticationController::class, 'regenerateRecoveryCodes'])
        ->name('two-factor.recovery-codes.regenerate');

    Route::get('settings/sessions', [SessionController::class, 'index'])->name('sessions.index');
    Route::delete('settings/sessions/other', [SessionController::class, 'destroyOther'])->name('sessions.destroy-other');
